...
import { Upload, Download, Maximize2, FileText, X } from 'lucide-react';

export default function WordMargin() {
      ...
      <div className="max-w-4xl mx-auto">
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          <div className="text-center mb-8">
            <Maximize2 className="w-16 h-16 text-blue-600 mx-auto mb-4" />
