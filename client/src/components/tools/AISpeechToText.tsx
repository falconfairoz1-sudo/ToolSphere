...
import { Sparkles, Mic, Copy, Check, Download, Loader2 } from 'lucide-react';
...
export default function AISpeechToText() {
  ...
  const generate = async () => {
    ...
    try {
      ...
      const mockOutput = `AI Generated Output for: "AI Speech to Text"
...
Generated at: ${new Date().toLocaleString()}`;
  ...
  const downloadOutput = () => {
    ...
    a.href = url;
    a.download = 'ai-speech-to-text-output.txt';
    a.click();
