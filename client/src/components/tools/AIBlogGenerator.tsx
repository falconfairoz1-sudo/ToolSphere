...
import { Sparkles, BookOpen, Copy, Check, Download, Loader2 } from 'lucide-react';
...
export default function AIBlogGenerator() {
  ...
  const generate = async () => {
    ...
    try {
      ...
      const mockOutput = `AI Generated Output for: "AI Blog Generator"
...
Generated at: ${new Date().toLocaleString()}`;
  ...
  const downloadOutput = () => {
    ...
    a.href = url;
    a.download = 'ai-blog-generator-output.txt';
    a.click();
