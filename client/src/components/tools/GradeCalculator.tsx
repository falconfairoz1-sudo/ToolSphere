        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-2xl p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              Calculate final grades with weighted assignments
            </p>
          </div>
          ...
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-700 dark:to-gray-800 rounded-xl p-8 text-center">
            ...
            <p className="text-gray-600 dark:text-gray-400 mb-4">
              Full implementation of Grade Calculator coming soon.
            </p>
            <p className="text-sm text-gray-500 dark:text-gray-500">
              This tool will help you calculate final grades with weighted assignments.
            </p>
          </div>
        </div>
      </div>
