        ...
        {result && (
          <div className="space-y-4">
            <div className="p-6 bg-gradient-to-br from-primary-50 to-purple-50 dark:from-primary-900/20 dark:to-purple-900/20 rounded-xl text-center">
              ...
              <p className="text-5xl font-black text-primary-600">₹{result.emi}</p>
            </div>

            <div className="grid md:grid-cols-3 gap-4">
              <div className="p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg text-center">
                <p className="text-sm text-blue-600 dark:text-blue-400 mb-1">Principal Amount</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">₹{result.principal}</p>
              </div>
              <div className="p-4 bg-green-50 dark:bg-green-900/20 rounded-lg text-center">
                <p className="text-sm text-green-600 dark:text-green-400 mb-1">Total Interest</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">₹{result.totalInterest}</p>
              </div>
              <div className="p-4 bg-orange-50 dark:bg-orange-900/20 rounded-lg text-center">
                <p className="text-sm text-orange-600 dark:text-orange-400 mb-1">Total Amount</p>
                <p className="text-2xl font-bold text-gray-900 dark:text-white">₹{result.totalAmount}</p>
              </div>
            </div>

            {/* Breakdown */}
            <div className="p-4 bg-gray-50 dark:bg-gray-700 rounded-lg">
              <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-3">Payment Breakdown:</p>
              <div className="space-y-2">
                ...
                <div className="flex justify-between text-sm border-t border-gray-300 dark:border-gray-600 pt-2">
                  ...
                  <span className="font-bold text-gray-900 dark:text-white">₹{result.totalAmount}</span>
                </div>
              </div>
            </div>
          </div>
