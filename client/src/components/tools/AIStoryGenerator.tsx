...
import { Sparkles, Book, Copy, Check, Download, Loader2 } from 'lucide-react';
...
export default function AIStoryGenerator() {
  ...
  const generate = async () => {
    ...
    try {
      ...
      const mockOutput = `AI Generated Output for: "AI Story Generator"
...
Generated at: ${new Date().toLocaleString()}`;
  ...
  const downloadOutput = () => {
    ...
    a.href = url;
    a.download = 'ai-story-generator-output.txt';
    a.click();
