...
import { Sparkles, CheckCircle, Copy, Check, Download, Loader2 } from 'lucide-react';
...
export default function AIGrammarChecker() {
  ...
  const generate = async () => {
    ...
    try {
      ...
      const mockOutput = `AI Generated Output for: "AI Grammar Checker"
...
Generated at: ${new Date().toLocaleString()}`;
  ...
  const downloadOutput = () => {
    ...
    a.href = url;
    a.download = 'ai-grammar-checker-output.txt';
    a.click();
