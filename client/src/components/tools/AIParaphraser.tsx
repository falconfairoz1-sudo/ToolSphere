...
import { Sparkles, RefreshCw, Copy, Check, Download, Loader2 } from 'lucide-react';
...
export default function AIParaphraser() {
  ...
  const generate = async () => {
    ...
    try {
      ...
      const mockOutput = `AI Generated Output for: "AI Paraphraser"
...
Generated at: ${new Date().toLocaleString()}`;
  ...
  const downloadOutput = () => {
    ...
    a.href = url;
    a.download = 'ai-paraphraser-output.txt';
    a.click();
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Rewrite text while keeping meaning
            </p>
          </div>
